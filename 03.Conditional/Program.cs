namespace _03._Conditional
{
	internal class Program
	{
		static void Main(string[] args)
		{
             ...
             ****************************************************************/
			// if로 모든 switch를 대체할 수 있다.
			// 하지만 if로 w W ㅈ 를 모두 처리하기엔 길어지고 가독성이 떨어짐 그래서 짧게 짤 수 있는건 스위치로 하는 것도 좋다
			// swirch는 여러 값들을 처리할 때 좋다. 단 > , < 등 산술 사용이 불가능하다. 딱 뭐가 뭐일 때만 실행이 된다.
			// 뭐가 좋다가 아니라 편한 상황일 때 선택해서 사용하면 된다. 범위 보다 값을 따질 때 switch를 사용하자.
			...
			switch (cmd)        // 조건값 지정
			{
				case "A":       // 조건값이 일치하지 않아 넘어감
					...
					break;		// break 를 안 쓰면 문법 오류임 무조건 써야한다.
